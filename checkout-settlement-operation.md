...
# Checkout settlement operations (ideal behavior for gcash and xendit)
```mermaid
---
title:
---
...
# Checkout settlement operations (ideal behavior for maya)
```mermaid
---
title:
---
flowchart TB;
    ...
    D-- Refund status is not success -->X[Return 422];
    D-- Refund status is success -->Z[Update refunded amount];
    Z-->E["Set settlement status to *settled*"];
    E-->F[Return 200];
```
